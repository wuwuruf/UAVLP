...
for epoch in range(num_pre_epochs):
    ...
    f_input = open('res/%s_IDEA_rec.txt' % (data_name), 'a+')
    f_input.write('(L3) Val Pre #%d RMSE %f %f MAE %f %f MLSD %f %f MR %f %f Time %s\n'
            % (epoch, RMSE_mean_L3, RMSE_std_L3, MAE_mean_L3, MAE_std_L3,
                MLSD_mean_L3, MLSD_std_L3, MR_mean_L3, MR_std_L3, current_time))
    f_input.close()
...
for epoch in range(num_epochs):
    ...
    print('(L3) Test #%d RMSE %f %f MAE %f %f MLSD %f %f MR %f %f\n'
          % (epoch, RMSE_mean_L3, RMSE_std_L3, MAE_mean_L3, MAE_std_L3,
             MLSD_mean_L3, MLSD_std_L3, MR_mean_L3, MR_std_L3))
    f_input = open('res/%s_IDEA_rec.txt' % (data_name), 'a+')
    f_input.write('(L3) Test #%d RMSE %f %f MAE %f %f MLSD %f %f MR %f %f Time %s\n'
            % (epoch, RMSE_mean_L3, RMSE_std_L3, MAE_mean_L3, MAE_std_L3,
                MLSD_mean_L3, MLSD_std_L3, MR_mean_L3, MR_std_L3, current_time))
    f_input.write('\n')
    f_input.close()
